...
const teleCmdId: string = 'vscode-docker.image.acrbuild';
...
export async function acrBuildImage(dockerFileUri?: vscode.Uri) {
    ...
    // }
    let contextPath: string = "."; //sajaya #Prompt for context
    ...
    terminal.sendText(`az acr build -f ${uri.file} -t ${value} ${contextPath}`);
    terminal.show();
